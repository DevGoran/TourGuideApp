...
public class StJohnsPlacesActivity extends MainPlacesActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CategoryFragmentPagerAdapter adapter = new CategoryFragmentPagerAdapter(StJohnsPlacesActivity.this, getSupportFragmentManager(), getLifecycle());
