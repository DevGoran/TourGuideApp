...
public class VancouverActivity extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CategoryFragmentPagerAdapter adapter = new CategoryFragmentPagerAdapter(VancouverActivity.this, getSupportFragmentManager(), getLifecycle());
