...
public class CalgaryPlacesActivity extends MainPlacesActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CategoryFragmentPagerAdapter adapter = new CategoryFragmentPagerAdapter(CalgaryPlacesActivity.this, getSupportFragmentManager(), getLifecycle());
